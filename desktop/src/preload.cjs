...
contextBridge.exposeInMainWorld(
  ...
  Object.freeze({
    ...
    listTasks: () => ipcRenderer.invoke("farmops:list-tasks"),
    createTask: (input) => ipcRenderer.invoke("farmops:create-task", input),
    updateTask: (input) => ipcRenderer.invoke("farmops:update-task", input),
    deleteTask: (input) => ipcRenderer.invoke("farmops:delete-task", input),
