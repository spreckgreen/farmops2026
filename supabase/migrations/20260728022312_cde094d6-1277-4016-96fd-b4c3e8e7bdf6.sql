CREATE OR REPLACE FUNCTION public.schema_diagnostics()
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
REVOKE ALL ON FUNCTION public.schema_diagnostics() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.schema_diagnostics() TO authenticated;