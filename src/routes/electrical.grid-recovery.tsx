...
export const Route = createFileRoute("/electrical/grid-recovery")({
  component: GridRecoveryPage,
  head: () => ({
    meta: [
      { title: "Farm Shop Grid Recovery Validation — Bostead Farms" },
      {
        name: "description",
        content:
          "Read-only Farm Shop grid map rebuilt from the SHA-authorized canonical Load_Master Grid field, with FarmOps grid disagreements flagged and no location written.",
      },
      { property: "og:title", content: "Farm Shop Grid Recovery Validation — Bostead Farms" },
      {
        property: "og:description",
        content:
          "Canonical-derived Farm Shop device placement validation with overlay classification and source-of-grid delta reporting.",
      },
