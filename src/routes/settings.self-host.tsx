...
function RunAiTestCard() {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        <p className="text-sm text-muted-foreground">
          Sends a short prompt (<code>Say &apos;AI test OK&apos;</code>) through the
          currently-configured AI provider and reports which endpoint answered,
          the round-trip latency, and the HTTP status.
        </p>
