...
export const Route = createFileRoute("/electrical/mapping-audit")({
  component: MappingAuditPage,
  head: () => ({
    meta: [
      { title: "Load_Master Field-Mapping Audit — Bostead Farms" },
      {
        name: "description",
        content:
          "Preview-only audit comparing canonical Load_Master physical columns and exact headers against the FarmOps import mapping, with a row-level correction preview and no writes.",
      },
      { property: "og:title", content: "Load_Master Field-Mapping Audit — Bostead Farms" },
      {
        property: "og:description",
        content:
          "Determines whether NULL suggested_panel, blank D/S and misplaced Backup Priority values are a deterministic import-column mapping defect.",
      },
