...
//
// Rendered as a section of /electrical/import-contract. Canonical never
// automatically overwrites FarmOps: no write, no apply gate, no Phase 4.5.
...
export function ContractV3ReconciliationPanel() {
