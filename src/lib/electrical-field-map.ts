...
export const FIELD_MAP: FieldMapRow[] = [
  ...
  { worksheet: "Panels", field: "Raceway exits from panel", classification: "directly_mapped", farmops: "electrical_panel_exits (panel_uuid, raceway_uuid, exit_order, exit_side)", authority: "shared", transformation: "Physical exit order is stored separately from the CON-### / EMT-### raceway identity; order is unique per panel and starts lower-right, counterclockwise.", coverage: "complete" },
  ...
  // ------------------------------------------------------------ Conduit_Runs
  { worksheet: "Conduit_Runs", field: "Conduit ID", classification: "directly_mapped", farmops: "electrical_raceways.conduit_id", authority: eng, transformation: "EMT-### going forward; existing CON-### IDs stay valid and are never renamed.", coverage: "complete" },
